...
export default function WareHouseTable() {
 ...
 <TableContainer component={Paper}>
      <Table sx={{ minWidth: 650 }} aria-label="caption table">
        ...
        <TableHead>
          <TableRow>
            <TableCell><b className='th'>Blog-Title</b></TableCell>
            <TableCell align="right"><b className='th'>Blog-Summary</b></TableCell>
            <TableCell align="right"><b className='th'>Blog-Description</b></TableCell>
